...
const CreateRepository: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push(`/repository/${formData.name}`);
      }, 2000);
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          ...
          {successMessage && (
            <div className="mb-6 p-4 bg-primary/10 border border-primary/30 rounded-lg flex items-center text-primary">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-6">
                ...
                <Input
                  ...
                  className={`w-full ${errors.name ? 'border-destructive focus:ring-destructive' : ''}`}
              ...
              <div className="mb-6">
                <label className="block text-foreground text-sm font-medium mb-2" htmlFor="description">
                  Description
                </label>
                <Textarea
                  id="description"
                  ...
                  onChange={handleInputChange}
                  rows={3}
                  className={`w-full ${errors.description ? 'border-destructive focus:ring-destructive' : ''}`}
